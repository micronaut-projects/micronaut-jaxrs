...
Current baseline: `:micronaut-tests:micronaut-jaxrs-tck:test` passes with existing exclusions, reporting `2803` tests, `2095` passed, `0` failures/errors, and `708` skipped. `tests/jaxrs-tck/failingTests.xml` currently tracks `96` known-failing entries: `46` classes and `50` methods.

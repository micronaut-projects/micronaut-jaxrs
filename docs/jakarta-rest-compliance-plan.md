...
Current baseline: `:micronaut-tests:micronaut-jaxrs-tck:test` passes with existing exclusions, reporting `2803` tests, `2087` passed, `0` failures/errors, and `716` skipped. `tests/jaxrs-tck/failingTests.xml` currently tracks `104` known-failing entries: `46` classes and `58` methods.

...
Current baseline: `:micronaut-tests:micronaut-jaxrs-tck:test` passes with existing exclusions, reporting `2764` tests, `2070` passed, `0` failures/errors, and `694` skipped. `tests/jaxrs-tck/failingTests.xml` currently tracks `131` known-failing entries: `46` classes and `85` methods.

...
The readers and writers of the application are selected before the standard ones: by the most specific media type they declare, then by the nearest type.

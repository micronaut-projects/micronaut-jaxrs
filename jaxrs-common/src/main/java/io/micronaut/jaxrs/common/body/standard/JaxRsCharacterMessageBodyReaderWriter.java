...
/**
 * The read/write body for {@link Character}.
 *
...
@JaxRsMessageBodyProvider(
    readerType = Character.class,
    writerType = Character.class,
...
@Prototype
@Internal
final class JaxRsCharacterMessageBodyReaderWriter implements jakarta.ws.rs.ext.MessageBodyReader<Character>, MessageBodyWriter<Character> {
    ...
    public Character readFrom(Class<Character> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) throws IOException, WebApplicationException {
        return JaxRsStringMessageBodyReaderWriter.readToString(entityStream, mediaType, true).charAt(0);
    }
